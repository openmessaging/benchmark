...
class RateControllerTest {
    ...
    void receiveBacklog() {
        ...
        // no backlog
        rate = rateController.nextRate(rate, periodNanos, 10_000, 10_000, 0, 0);
        assertThat(rate).isEqualTo(20_000);
        assertThat(rateController.getRampingFactor()).isEqualTo(1);

        // receive backlog
        rate = rateController.nextRate(rate, periodNanos, 20_000, 15_000, 0, 0);
    ...
    void publishBacklog() {
        ...
        // publish backlog
        rate = rateController.nextRate(rate, periodNanos, 15_000, 20_000, 0, 0);
        assertThat(rate).isEqualTo(5_000);
        assertThat(rateController.getRampingFactor()).isEqualTo(0.5);
    }
    ...
    void rampUp() {
        ...
        // receive backlog
        rate = rateController.nextRate(rate, periodNanos, 10_000, 5_000, 0, 0);
        assertThat(rate).isEqualTo(5_000);
        assertThat(rateController.getRampingFactor()).isEqualTo(0.5);

        // no backlog
        rate = rateController.nextRate(rate, periodNanos, 20_000, 20_000, 0, 0);
